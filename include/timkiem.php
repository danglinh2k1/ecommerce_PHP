							...
							<div class="left-side py-2">
								<ul>
									<li>
										...
										<span class="span">Giày Nike</span>
									</li>
									<li>
										<input type="checkbox" class="checked">
										<span class="span">Giày Lười</span>
									</li>
									<li>
										<input type="checkbox" class="checked">
										<span class="span">Giày snacker</span>
									</li>
									<li>
										<input type="checkbox" class="checked">
										<span class="span">Giày MLB</span>
									</li>
									<li>
										<input type="checkbox" class="checked">
										<span class="span">Giày Thể Thao</span>
									</li>
