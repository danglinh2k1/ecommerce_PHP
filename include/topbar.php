...
<!-- top-header -->
			...
			<div class="row main-top-w3l py-2">
				...
				<div class="col-lg-8 header-right mt-lg-0 mt-2">
					...
					<ul>
						...
						?>
						<li class="text-center border-right text-white">
							<i class="fas fa-phone mr-2"></i> 0385359725
						</li>
						<li class="text-center border-right text-white">
	...
	<!-- header-bottom-->
	<div class="header-bot" style="position:relative;">
		<div class="container">
			<div class="row header-bot_inner_wthreeinfo_header_mid">
				<!-- logo -->
				<div class="col-md-3 logo_agile">
					<h1 class="text-center" class="font-weight-bold font-italic" style="color:green; ">Đăng Linh </h1>
				</div>
				<div class="img-logo__avata">
				<a href="index.php">
							<img src="../images/avatar-PhotoRoom.png" alt=" " class="img-fluid" >
						</a>
						</div>
				<!-- //logo -->
				<!-- header-bot -->
					...
					<div class="row">
						...
						<div class="col-10 agileits_search">
							<form class="form-inline" action="index.php?quanly=timkiem" method="POST">
								<input class="form-control mr-sm-2" name="search_product" type="search" placeholder="Tìm kiếm sản phẩm" aria-label="Search" required style="color:aqua">
